...
class ProductAdapter(context: Context?, var customers: ArrayList<MultiModel>) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (txtCustomer != null) txtCustomer.text = customer!!.productName
        return convertView
    }
        ...
        override fun performFiltering(constraint: CharSequence): FilterResults {
            return if (constraint != null) {
                ...
                for (people in tempCustomer) {
                    if (people.productName!!.lowercase(Locale.getDefault()).startsWith(
